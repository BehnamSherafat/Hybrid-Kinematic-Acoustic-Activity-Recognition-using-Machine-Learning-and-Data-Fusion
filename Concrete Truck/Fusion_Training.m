...
PCA_f = 0.9;
cross_fold = 10;
% delay = 1.108; % how much audio is prior to vibration
delay = 0.608;
...
[A_ori, fsA] = audioread('ZOOM0034.wav');

%% Audio Denoising: method = 'mcra2'; 

A_ori(A_ori==0)=10^-4;
A_ori = A_ori(:, 1);
audiowrite('ZOOM0034_ori.wav', A_ori, fsA);

% Audio Denoising: method = 'mcra2'; 
% specsub_ns('ZOOM0034_ori.wav', 'mcra2', 'ZOOM0034_den.wav')

% Read Modified Audio
[S_Audio, fsA] = audioread('ZOOM0034_den.wav');
...
% Categorizing Data
Activity_1 = Data(s1:f1,:);
Activity_2 = Data(s2:f2,:);
