...
markovV_m = [0.987089202,	0.012910798; 0.012910798,	0.987089202];
sum(markovV_m,2)

markovA_m = [0.987089202,	0.012910798; 0.012910798,	0.987089202];
sum(markovA_m,2)
...
[A_ori, fsA] = audioread('ZOOM0018.wav');

%% Audio Denoising: method = 'mcra2'; 

A_ori(A_ori==0)=10^-4;
A_ori = A_ori(:, 1);
audiowrite('ZOOM0018_ori.wav', A_ori, fsA);
...
subplot(4,1,2)
[V_Spec, ~, ~, ~, ~, ~, ~, ~] = FunctionExtractionV(S_Vibration, 0, t_F, fsV, FFTSIZE, V_noverlap, V_WINDOWSIZE);
...
subplot(4,1,4)
[A_Spec, ~, ~, ~, ~, ~, ~, ~] = FunctionExtractionA(S_Audio, 0, t_F, fsA, FFTSIZE, A_noverlap, A_WINDOWSIZE);
...
lps = length(label_act)/(t_F-start_Vibration); % length per second 

minor_start1 = ceil(start_Vibration*lps+1);
minor_end1 = ceil(10*lps);
minor_start2 = ceil(19*lps);
minor_end2 = ceil(20*lps);
minor_start3 = ceil(26.5*lps);
minor_end3 = ceil(28*lps);
minor_start4 = ceil(38.7*lps);
minor_end4 = ceil(40.2*lps);
minor_start5 = ceil(48.4*lps);
minor_end5 = ceil(53*lps);
minor_start6 = ceil(64.9*lps);
minor_end6 = ceil(66*lps);
minor_start7 = ceil(74*lps);
minor_end7 = ceil(80.6*lps);
minor_start8 = ceil(91.1*lps);
minor_end8 = ceil(92.9*lps);
minor_start9 = ceil(98*lps);
minor_end9 = ceil(t_F*lps-1);
...
set(gca, 'XTickLabelMode', 'manual', 'XTickLabel', []);
set(gca, 'YTickLabelMode', 'manual', 'YTickLabel', []);
title('SkyJack SJ6826 Vibration "Predicted SW"',...
...
set(gca, 'XTickLabelMode', 'manual', 'XTickLabel', []);
set(gca, 'YTickLabelMode', 'manual', 'YTickLabel', []);
title('SkyJack SJ6826 Vibration "Predicted BW"',...
    'FontSize', 18, 'FontWeight','bold');
y=ylabel({'Normalized', 'Frequency'}, 'FontSize', 18, 'FontWeight','bold');
set(y, 'Units', 'Normalized', 'Position', [-0.1, 0.5, 0]);
set(get(gca,'ylabel'),'rotation',0)
...
set(gca, 'XTickLabelMode', 'manual', 'XTickLabel', []);
set(gca, 'YTickLabelMode', 'manual', 'YTickLabel', []);
title('SkyJack SJ6826 Vibration "Predicted Markov"',...
    'FontSize', 18, 'FontWeight','bold');
y=ylabel({'Normalized', 'Frequency'}, 'FontSize', 18, 'FontWeight','bold');
set(y, 'Units', 'Normalized', 'Position', [-0.1, 0.5, 0]);
set(get(gca,'ylabel'),'rotation',0)
...
set(gca, 'XTickLabelMode', 'manual', 'XTickLabel', []);
set(gca, 'YTickLabelMode', 'manual', 'YTickLabel', []);
title('SkyJack SJ6826 Vibration "Correct Label"',...
    'FontSize', 18, 'FontWeight','bold');
y=ylabel({'Normalized', 'Frequency'}, 'FontSize', 18, 'FontWeight','bold');
set(y, 'Units', 'Normalized', 'Position', [-0.1, 0.5, 0]);
set(get(gca,'ylabel'),'rotation',0)
...
set(gca, 'XTickLabelMode', 'manual', 'XTickLabel', []);
set(gca, 'YTickLabelMode', 'manual', 'YTickLabel', []);
title('SkyJack SJ6826 Audio "Predicted SW"',...
    'FontSize', 18, 'FontWeight','bold');
y=ylabel({'Normalized', 'Frequency'}, 'FontSize', 18, 'FontWeight','bold');
set(y, 'Units', 'Normalized', 'Position', [-0.1, 0.5, 0]);
set(get(gca,'ylabel'),'rotation',0)
...
set(gca, 'XTickLabelMode', 'manual', 'XTickLabel', []);
set(gca, 'YTickLabelMode', 'manual', 'YTickLabel', []);
title('SkyJack SJ6826 Audio "Predicted BW"',...
    'FontSize', 18, 'FontWeight','bold');
y=ylabel({'Normalized', 'Frequency'}, 'FontSize', 18, 'FontWeight','bold');
set(y, 'Units', 'Normalized', 'Position', [-0.1, 0.5, 0]);
set(get(gca,'ylabel'),'rotation',0)
...
set(gca, 'XTickLabelMode', 'manual', 'XTickLabel', []);
set(gca, 'YTickLabelMode', 'manual', 'YTickLabel', []);
title('SkyJack SJ6826 Audio "Predicted Markov"',...
    'FontSize', 18, 'FontWeight','bold');
y=ylabel({'Normalized', 'Frequency'}, 'FontSize', 18, 'FontWeight','bold');
set(y, 'Units', 'Normalized', 'Position', [-0.1, 0.5, 0]);
set(get(gca,'ylabel'),'rotation',0)
...
set(gca, 'XTickLabelMode', 'manual', 'XTickLabel', []);
set(gca, 'YTickLabelMode', 'manual', 'YTickLabel', []);
title('SkyJack SJ6826 Audio "Correct Label"',...
    'FontSize', 18, 'FontWeight','bold');
y=ylabel({'Normalized', 'Frequency'}, 'FontSize', 18, 'FontWeight','bold');
set(y, 'Units', 'Normalized', 'Position', [-0.1, 0.5, 0]);
set(get(gca,'ylabel'),'rotation',0)
...
set(gca, 'XTickLabelMode', 'manual', 'XTickLabel', []);
set(gca, 'YTickLabelMode', 'manual', 'YTickLabel', []);
title('SkyJack SJ6826 Data Fusion "Predicted SW"',...
    'FontSize', 18, 'FontWeight','bold');
y=ylabel({'Normalized', 'Frequency'}, 'FontSize', 18, 'FontWeight','bold');
set(y, 'Units', 'Normalized', 'Position', [-0.1, 0.5, 0]);
set(get(gca,'ylabel'),'rotation',0)
...
set(gca, 'XTickLabelMode', 'manual', 'XTickLabel', []);
set(gca, 'YTickLabelMode', 'manual', 'YTickLabel', []);
title('SkyJack SJ6826 Data Fusion "Predicted BW"',...
    'FontSize', 18, 'FontWeight','bold');
y=ylabel({'Normalized', 'Frequency'}, 'FontSize', 18, 'FontWeight','bold');
set(y, 'Units', 'Normalized', 'Position', [-0.1, 0.5, 0]);
set(get(gca,'ylabel'),'rotation',0)
...
set(gca, 'XTickLabelMode', 'manual', 'XTickLabel', []);
set(gca, 'YTickLabelMode', 'manual', 'YTickLabel', []);
title('SkyJack SJ6826 Data Fusion "Predicted Markov"',...
    'FontSize', 18, 'FontWeight','bold');
y=ylabel({'Normalized', 'Frequency'}, 'FontSize', 18, 'FontWeight','bold');
set(y, 'Units', 'Normalized', 'Position', [-0.1, 0.5, 0]);
set(get(gca,'ylabel'),'rotation',0)
...
set(gca, 'XTickLabelMode', 'manual', 'XTickLabel', []);
set(gca, 'YTickLabelMode', 'manual', 'YTickLabel', []);
title('SkyJack SJ6826 Data Fusion "Correct Label"',...
    'FontSize', 18, 'FontWeight','bold');
y=ylabel({'Normalized', 'Frequency'}, 'FontSize', 18, 'FontWeight','bold');
set(y, 'Units', 'Normalized', 'Position', [-0.1, 0.5, 0]);
set(get(gca,'ylabel'),'rotation',0)
