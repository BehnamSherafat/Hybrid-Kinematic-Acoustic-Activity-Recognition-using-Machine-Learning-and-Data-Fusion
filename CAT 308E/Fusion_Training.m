...
PCA_f = 0.9;
cross_fold = 10;
delay = 1.5706; % how much audio is prior to vibration
...
[A_ori, fsA] = audioread('ZOOM0022.wav');

%% Audio Denoising: method = 'mcra2'; 

A_ori(A_ori==0)=10^-4;
A_ori = A_ori(:, 1);
audiowrite('ZOOM0022_ori.wav', A_ori, fsA);

% Audio Denoising: method = 'mcra2'; 
% specsub_ns('ZOOM0022_ori.wav', 'mcra2', 'ZOOM0022_den.wav')

% Read Modified Audio
[S_Audio, fsA] = audioread('ZOOM0022_den.wav');
...
% Categorizing Data
Activity_1 = [Data(s3:f3,:);Data(s5:f5,:);Data(s7:f7,:);Data(s8:f8,:);Data(s9:f9,:);Data(s10:f10,:);Data(s11:f11,:);Data(s13:f13,:);Data(s14:f14,:);Data(s16:f16,:);Data(s18:f18,:);Data(s20:f20,:);Data(s22:f22,:);Data(s24:f24,:);Data(s26:f26,:);Data(s28:f28,:)];
...
% Activity_3 = [Data(s6:f6,:);Data(s8:f8,:)];
% Activity_4 = [Data(s10:f10,:);Data(s12:f12,:);Data(s14:f14,:)];
